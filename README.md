...
备份包括 `sections`、`articles`、`users`、`submissions`、`review_events` 和 `contributors`。脚本采用分页读取、临时文件原子落盘、JSON 回读校验和 SHA-256 校验文件，保留最近 30 份。备份包含学号、未公开投稿和审核记录，严禁上传到公开仓库或公开网盘。
