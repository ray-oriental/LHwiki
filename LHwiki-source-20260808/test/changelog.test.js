...
test('站内更新日志倒序覆盖所有历史版本且不记录改名', () => {
  assert.deepEqual(CHANGELOG_ENTRIES.map(entry => entry.version), [
    'v0.9.1', 'v0.9.0', 'v0.8.10', 'v0.8.9', 'v0.8.8', 'v0.8.7', 'v0.8.6', 'v0.8.5', 'v0.8.4', 'v0.8.3', 'v0.8.2', 'v0.8.1', 'v0.8.0', 'v0.7.0', 'v0.6.0', 'v0.5.1', 'v0.5.0', 'v0.4.0', 'v0.3.0', 'v0.2.0', 'v0.1.0'
  ]);
...
test('发布版本在包、两份 Markdown 日志和站内日志之间保持一致', async () => {
  ...
  let rootLog = sourceLog;
  try {
    rootLog = await readFile(new URL('../../CHANGELOG.md', import.meta.url), 'utf8');
  } catch (error) {
